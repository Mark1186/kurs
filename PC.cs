...
namespace Kursach
{
    public partial class PC : Form
    {
        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM PC", connection);
                    SqlDataAdapter adapter1 = new SqlDataAdapter("SELECT Id FROM Type_PC", connection);
                    SqlDataAdapter adapter2 = new SqlDataAdapter("SELECT Id FROM Document_Mov", connection);
                    SqlDataAdapter adapter3 = new SqlDataAdapter("SELECT Id FROM Division", connection);
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("INSERT INTO PC (Inv_Number, TypePC_Id, DocumentMov_Id, Division_Id) VALUES ('" + textBox1.Text + "','" + comboBox1.Text + "','" + comboBox2.Text + "', '" + comboBox3.Text + "')", connection);
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("DELETE FROM PC WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("UPDATE PC SET Inv_Number='" + textBox1.Text + "', TypePC_Id='" + comboBox1.Text + "', DocumentMov_Id='" + comboBox2.Text + "', Division_Id='" + comboBox3.Text + "' WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            comboBox2.Text = dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[3].Value.ToString();
            comboBox3.Text = dataGridView1.Rows[dataGridView1.CurrentRow.Index].Cells[4].Value.ToString();
        }
