        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM Phone", connection);
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("INSERT INTO PHone (Number) VALUES ('" + textBox1.Text + "')", connection);
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("DELETE FROM Phone WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("UPDATE Phone SET Number='" + textBox1.Text + "' WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
