...
namespace Kursach
{
    public partial class Document_Mov : Form
    {
        ...
        private void Document_Mov_Load(object sender, EventArgs e)
        {
            tbId.ReadOnly = true;
        }
        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM Document_Mov", connection);
                    SqlDataAdapter adapter1 = new SqlDataAdapter("SELECT * FROM Type_Document", connection);
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("INSERT INTO Document_Mov (Doc_Number, Short_Name, Installation_Date, TypeDocument_Id) VALUES ('" + textBox1.Text + "','" + dateTimePicker1.Value.Date + "','" + comboBox1.Text + "')", connection);
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("DELETE FROM Document_Mov WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("UPDATE Document_Mov SET Doc_Number='" + textBox1.Text + "', Installation_Date='" + dateTimePicker1.Value.Date + "', TypeDocument_Id='" + comboBox1.Text + "' WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
