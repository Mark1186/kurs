...
namespace Kursach
{
    public partial class PC_Software : Form
    {
        ...
        private void PC_Software_Load(object sender, EventArgs e)
        {
            tbId.ReadOnly = true;
        }
        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM PC_Software", connection);
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("INSERT INTO PC_Software (PC_Id, Software_Id) VALUES ('" + textBox1.Text + "','" + textBox2.Text + "')", connection);
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("DELETE FROM PC_Software WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("UPDATE PC_Software SET PC_Id='" + textBox1.Text + "', Software_Id='" + textBox2.Text + "' WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
