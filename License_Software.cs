...
namespace Kursach
{
    public partial class License_Software : Form
    {
        string connectionString = @"Data Source=MARK-PC;Initial Catalog=KurSoft;Integrated Security=True";

        public License_Software()
        {
            InitializeComponent();
        }

        private void License_Software_Load(object sender, EventArgs e)
        {
            tbId.ReadOnly = true;
        }
        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("SELECT * FROM License_Software", connection);
                    SqlDataAdapter adapter1 = new SqlDataAdapter("SELECT Id FROM Software", connection);
                    SqlDataAdapter adapter2 = new SqlDataAdapter("SELECT Id FROM License", connection);
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("INSERT INTO License_Software (Type_License, Software_Id, License_Id) VALUES ('" + textBox1.Text + "','" + comboBox1.Text + "','" + comboBox2.Text + "')", connection);
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("DELETE FROM License_Siftware WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("UPDATE License_Software SET Type_License='" + textBox1.Text + "', Software_Id='" + comboBox1.Text + "',License_Id='" + comboBox2.Text + "' WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
