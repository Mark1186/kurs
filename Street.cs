        ...
        private async void button5_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter1 = new SqlDataAdapter("SELECT Id FROM Human_Settlement", connection);
                    SqlDataAdapter adapter2 = new SqlDataAdapter("SELECT Id FROM Type_Street", connection);
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("INSERT INTO Street (Name, HumanSet_Id, TypeStreet_Id) VALUES ('" + textBox1.Text + "','" + comboBox1.Text + "','" + comboBox2.Text + "')", connection);
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("DELETE FROM Street WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
        ...
        private async void button4_Click(object sender, EventArgs e)
        {
            try
            {
                using (SqlConnection connection = new SqlConnection(connectionString))
                {
                    ...
                    SqlDataAdapter adapter = new SqlDataAdapter("UPDATE Street SET Name='" + textBox1.Text + "', HumanSet_Id='"+comboBox1.Text+"', TypeStreet_Id='"+comboBox2.Text+"' WHERE Id='" + tbId.Text + "'", connection);
                    adapter.SelectCommand.ExecuteNonQuery();
                }
            }
            catch (Exception ee)
